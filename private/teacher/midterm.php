      ...
      ?>
          ...
          <tr>
            ...
            if ($midterm_output_weight < 30) {
              echo
              "<td class='text-white' style='background-color: #ff8080;'><center>" . $midterm_output_weight . "</center></td>";
            } else {
            ?>
              <td>
              ...
              if ($midterm_performance_weight < 30) {
                echo
                "<td class='text-white' style='background-color: #ff8080;'><center>" . $midterm_performance_weight . "</center></td>";
              } else {
              ?>
                <td>
                  <center><a class="text-danger">
                ...
                if ($midterm_written_test_weight < 15) {
                  echo
                  "<td class='text-white' style='background-color: #ff8080;'><center>" . number_format((float)$midterm_written_test_weight, 2, ".", "") . "</center></td>";
                } else {
                ?>
                  <td>
                    <center><a class="text-danger">
                  ...
                  <td>
                    <center><a class="text-danger"><?php echo number_format((float)$midterm_2nd_quarter, 2, ".", ""); ?></a></center>
                  </td>
                  <td>
                    <center><a class="<?php if ($midterm_grade >= 74.5) {
                                        echo 'text-success';
                                      } else {
                                        echo 'text-danger';
                                      } ?>"><?php echo number_format((float)$midterm_grade, 2, ".", ""); ?></a></center>
                  </td>
                  <td>
                    <center><a class="<?php if ($midterm_grade >= 74.5) {
                                        echo 'text-success';
                                        ...
                                        echo 'text-danger';
                                      } ?>"><?php echo $midterm_grade_equivalent; ?></a></center>
                  </td>
                  <td>
                    <center><a data-toggle="tooltip" title="Hooray!" class="<?php if ($midterm_remarks == 'Failed') {
                                                                              echo 'text-danger';
                                                                            } else {
                                                                              echo 'text-success';
                                                                            } ?>"><?php echo $midterm_remarks; ?></a></center>
                  </td>
                  <!-- <td><center><a <?php if ($check_prelim_grade > 0) {
                                        echo 'href=?redir=midterm&_y=' . $year . '&_c=' . $course . '&_s_e_=' . $semester . '&in_=' . $student_no;
                                      } else {
                                        echo 'data-toggle="tooltip" data-placement="top" title="Input prelim grade first!"';
                                      } ?> class="btn <?php if ($check_prelim_grade > 0) {
                                                        echo 'btn-primary';
                                                      } else {
