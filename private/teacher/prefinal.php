            ...
            ?>
              ...
              ?>
                ...
                ?>
                  ...
                  <td>
                    <center><a class="text-danger"><?php echo number_format((float)$prefinal_3rd_quarter, 2, ".", ""); ?></a></center>
                  </td>
                  <td>
                  ...
                  <!-- <td><center><a <?php if (($check_prelim_grade > 0) & ($check_midterm_grade > 0)) {
                                        echo 'href=?redir=prefinal&_y=' . $year . '&_c=' . $course . '&_s_e_=' . $semester . '&in_=' . $student_no;
                                      } else {
                                        echo 'data-toggle="tooltip" data-placement="top" title="Check other grading period before inputting grade"';
                                      } ?> class="btn <?php if (($check_prelim_grade > 0) & ($check_midterm_grade > 0)) {
                                                        echo 'btn-primary';
                                                      } else {
...
?>
  ...
  <div class="mt-5">
    <center>
      <a href="?redir=prefinal&_y=<?php echo $year; ?>&_c=<?php echo $course; ?>&_s_e_=<?php echo $semester; ?>&in_=output1" class="btn col-sm-2 mb-3 ml-3 new-color">Output 1 Grade</a>
      <a href="?redir=prefinal&_y=<?php echo $year; ?>&_c=<?php echo $course; ?>&_s_e_=<?php echo $semester; ?>&in_=output2" class="btn col-sm-2 mb-3 ml-3 new-color">Output 2 Grade</a>
      <a href="?redir=prefinal&_y=<?php echo $year; ?>&_c=<?php echo $course; ?>&_s_e_=<?php echo $semester; ?>&in_=performance1" class="btn col-sm-2 mb-3 ml-3 new-color">Performance 1 Grade</a>
      <a href="?redir=prefinal&_y=<?php echo $year; ?>&_c=<?php echo $course; ?>&_s_e_=<?php echo $semester; ?>&in_=performance2" class="btn col-sm-2 mb-3 ml-3 new-color">Performance 2 Grade</a>
      <a href="?redir=prefinal&_y=<?php echo $year; ?>&_c=<?php echo $course; ?>&_s_e_=<?php echo $semester; ?>&in_=written_test" class="btn col-sm-2 mb-3 ml-3 new-color">Major Exam Grade</a>
    </center>
  </div>
