...
<table border="1" class="table table-hover">
    ...
    <th class="px-3 text-center " style="background-color: #ff8080;" colspan="16">Prefinal Period</th></tr><!-- Prefinal Here -->

    <tr><th class="px-3">Student&nbsp;ID</th><th class="px-3">Student&nbsp;Name</th>
    <!-- <th class="px-5 text-center " style="background-color: #ff8080;" colspan="12">Formative Assessment</th> --><th class="px-5 text-center " style="background-color: #ff8080;" colspan="5">Output</th><th class="px-5 text-center " style="background-color: #ff8080;" colspan="5">Performance</th><th class="px-5 text-center " style="background-color: #ff8080;" colspan="3">Major&nbsp;Exam</th><th class="px-2 text-center " style="background-color: #ff8080;">3rd&nbsp;Quarter</th><th class="px-2 text-center " style="background-color: #ff8080;">Prefinal&nbsp;Grade</th><th class="px-2 text-center " style="background-color: #ff8080;">Equivalent</th></tr><!-- Prefinal Here -->

    <tr><th class="px-3"></th><th class="px-3">Highest&nbsp;Possible&nbsp;Score</th>
    <!-- <th class="" style="background-color: #ff8080;">10</th><th class="" style="background-color: #ff8080;">10</th><th class="" style="background-color: #ff8080;">10</th><th class="" style="background-color: #ff8080;">10</th><th class="" style="background-color: #ff8080;">10</th><th class="" style="background-color: #ff8080;">10</th><th class="" style="background-color: #ff8080;">10</th><th class="" style="background-color: #ff8080;">10</th><th class="" style="background-color: #ff8080;">10</th><th class="" style="background-color: #ff8080;">10</th><th class="" style="background-color: #ff8080;">100</th><th class="" style="background-color: #ff8080;">60</th> --><th class="" style="background-color: #ff8080;">20</th><th class="" style="background-color: #ff8080;">20</th><th class="" style="background-color: #ff8080;">40</th><th class="" style="background-color: #ff8080;">60</th><th class="" style="background-color: #ff8080;">0.40</th><th class="" style="background-color: #ff8080;">20</th><th class="" style="background-color: #ff8080;">20</th><th class="" style="background-color: #ff8080;">40</th><th class="" style="background-color: #ff8080;">60</th><th class="" style="background-color: #ff8080;">0.40</th><th class="" style="background-color: #ff8080;">70</th><th class="" style="background-color: #ff8080;">60</th><th class="" style="background-color: #ff8080;">0.20</th><th class="" style="background-color: #ff8080;"></th><th class="" style="background-color: #ff8080;"></th><th class="" style="background-color: #ff8080;"></th></tr><!-- Prefinal Here -->
    </thead>
...
if($prefinal_output_weight < 30){
  echo
  "<td class='bg-dadsdsdsdsdsdsdsnger tedsdsdsdsxt-whirte'><center>
