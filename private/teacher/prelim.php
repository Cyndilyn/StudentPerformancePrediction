...
<table border="1" class="table table-hover">
    <thead>
    <tr><th class="px-3" colspan="2"></th><th class="px-3 text-center " style="background-color:#86f9a3;" colspan="17">Preliminary Period</th></tr><!-- Preliminary Here -->

    <tr><th class="px-3">Student&nbsp;ID</th><th class="px-3">Student&nbsp;Name</th><!-- <th class="px-5 text-center " style="background-color:#86f9a3;" colspan="12">Formative Assessment</th> --><th class="px-5 text-center " style="background-color:#86f9a3;" colspan="5">Output</th><th class="px-5 text-center " style="background-color:#86f9a3;" colspan="5">Performance</th><th class="px-5 text-cente " style="background-color:#86f9a3;" colspan="3">Major&nbsp;Exam</th><th class="px-2 text-center"  style="background-color:#86f9a3;">Prelim&nbsp;Grade</th><th class="px-2 text-center"   style="background-color:#86f9a3;">Equivalent</th></tr><!-- Preliminary Here -->

    <tr><th class="px-3"></th><th class="px-3">Highest&nbsp;Possible&nbsp;Score</th><!-- <th class="" style="background-color:#86f9a3;">10</th><th class="" style="background-color:#86f9a3;">10</th><th class="" style="background-color:#86f9a3;">10</th><th class="" style="background-color:#86f9a3;">10</th><th class="" style="background-color:#86f9a3;">10</th><th class="" style="background-color:#86f9a3;">10</th><th class="" style="background-color:#86f9a3;">10</th><th class="" style="background-color:#86f9a3;">10</th><th class="" style="background-color:#86f9a3;">10</th><th class="" style="background-color:#86f9a3;">10</th><th class="" style="background-color:#86f9a3;">100</th><th class="" style="background-color:#86f9a3;">60</th> --><th class="" style="background-color:#86f9a3;">20</th><th class="" style="background-color:#86f9a3;">20</th><th class="" style="background-color:#86f9a3;">40</th><th class="" style="background-color:#86f9a3;">60</th><th class="" style="background-color:#86f9a3;">0.40</th><th class="" style="background-color:#86f9a3;">20</th><th class="" style="background-color:#86f9a3;">20</th><th class="" style="background-color:#86f9a3;">40</th><th class="" style="background-color:#86f9a3;">60</th><th class="" style="background-color:#86f9a3;">0.40</th><th class="" style="background-color:#86f9a3;">70</th><th class="" style="background-color:#86f9a3;">60</th><th class="" style="background-color:#86f9a3;">0.20</th><th class="" style="background-color:#86f9a3;"></th><th class="" style="background-color:#86f9a3;"></th></tr><!-- Preliminary Here -->
    </thead>
...
<input type="hidden" value="<?php if(isset($_GET["redir"])){ echo "prelim";} ?>" id="grade_period">
<input type="hidden" value="<?php if(isset($_GET["_y"])){ echo "2011";} ?>" id="year">
<input type="hidden" value="<?php if(isset($_GET["_c"])){ echo "BSIT";} ?>" id="course">
<input type="hidden" value="<?php if(isset($_GET["_s_e_"])){ echo "sem1";} ?>" id="semester">
