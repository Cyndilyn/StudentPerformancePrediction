  ...
  <table border="1" class="table table-hover table-no-padding">
    <thead>
      <tr>
        ...
        <th class="px-3 text-center" style="background-color:#347B98; color: white;" colspan="17">Preliminary Period</th>
      </tr><!-- Preliminary Here -->
    ...
    <tbody>
      ...
      ?>
          ...
          <tr>
            ...
            <td>
              <center><a class="text-primary"><?php echo $prelim_output_total_score; ?></a></center>
            </td>
            <td>
              <center><a class="text-primary"><?php echo $prelim_output_base; ?></a></center>
            </td>
            <!-- <td>
              <center><a class="text-primary"><?php echo $prelim_output_weight; ?></a></center>
            </td> -->
            <?php
            ...
            ?>
              ...
              <td>
                <center><a class="text-primary"><?php echo $prelim_performance_total_score; ?></a></center>
              </td>
              <td>
                <center><a class="text-primary"><?php echo $prelim_performance_base; ?></a></center>
              </td>
              <!-- <td>
                <center><a class="text-primary"><?php echo $prelim_performance_weight; ?></a></center>
              </td> -->
              <?php
              // echo $prelim_output_weight;
              ...
              ?>
                ...
                <td>
                  <center><a class="text-primary"><?php echo number_format((float)$prelim_written_test_base, 2, ".", ""); ?></a></center>
                </td>
                <!-- <td>
                  <center><a class="text-primary"><?php echo number_format((float)$prelim_written_test_weight, 2, ".", ""); ?></a></center>
                </td> -->
                <?php
                // echo $prelim_output_weight;
